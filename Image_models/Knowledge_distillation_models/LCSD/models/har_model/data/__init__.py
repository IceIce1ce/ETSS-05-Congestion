...
class CustomDataset(object):
    def __init__(self, opt, is_for_train):
        ...
        self.dataloader = torch.utils.data.DataLoader(self.dataset, batch_size=opt.batch_size, shuffle=is_for_train, num_workers=int(opt.num_threads), drop_last=False)
