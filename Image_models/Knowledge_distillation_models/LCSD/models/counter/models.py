...
class VGG(nn.Module):
    ...
    def forward(self, x): # [20, 3, 256, 256]
        ...
        return mu, mu_normed # [20, 1, 32, 32], [20, 1, 32, 32]
...
cfg = {'C': [64, 64, 'M', 128, 128, 'M', 256, 256, 256, 'M', 512, 512, 512], 'E': [64, 64, 'M', 128, 128, 'M', 256, 256, 256, 256, 'M', 512, 512, 512, 512, 'M', 512, 512, 512, 512]}
