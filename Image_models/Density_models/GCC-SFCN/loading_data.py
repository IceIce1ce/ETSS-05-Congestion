...
def loading_data():
    ...
    train_main_transform = own_transforms.Compose([own_transforms.RandomCrop(cfg.TRAIN.INPUT_SIZE), own_transforms.RandomHorizontallyFlip()])
    ...
    restore_transform = standard_transforms.Compose([own_transforms.DeNormalize(*mean_std), standard_transforms.ToPILImage()])
