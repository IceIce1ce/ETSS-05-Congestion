...
if __name__ == '__main__':
    ...
    part_A_train = os.path.join(args.input_dir, 'part_A/train_data', 'images')
    part_A_test = os.path.join(args.input_dir, 'part_A/test_data', 'images')
    part_B_train = os.path.join(args.input_dir, 'part_B/train_data', 'images')
    part_B_test = os.path.join(args.input_dir, 'part_B/test_data', 'images')
