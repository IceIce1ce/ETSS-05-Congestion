# https://github.com/XingangPan/IBN-Net/blob/master/ibnnet/resnet_ibn.py
import math
import warnings
import torch
import torch.nn as nn

__all__ = ['ResNet_IBN', 'resnet18_ibn_a', 'resnet34_ibn_a', 'resnet50_ibn_a', 'resnet101_ibn_a', 'resnet152_ibn_a', 'resnet18_ibn_b', 'resnet34_ibn_b',
           'resnet50_ibn_b', 'resnet101_ibn_b', 'resnet152_ibn_b']
model_urls = {'resnet18_ibn_a': 'https://github.com/XingangPan/IBN-Net/releases/download/v1.0/resnet18_ibn_a-2f571257.pth',
...
class ResNet_IBN(nn.Module):
    def __init__(self, block, layers, ibn_cfg=('a', 'a', 'a', None), num_classes=1000):
        self.inplanes = 64
    ...
    def _make_layer(self, block, planes, blocks, stride=1, ibn=None):
        ...
        layers = []
        layers.append(block(self.inplanes, planes, None if ibn == 'b' else ibn, stride, downsample))
        self.inplanes = planes * block.expansion
        for i in range(1, blocks):
            layers.append(block(self.inplanes, planes, None if (ibn == 'b' and i < blocks-1) else ibn))
