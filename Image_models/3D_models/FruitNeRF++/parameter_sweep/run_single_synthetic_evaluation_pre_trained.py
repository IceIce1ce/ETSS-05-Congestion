...
"""
ns-train cf-nerf-synthetic-cluster --data /home/woody/iwi9/iwi9019h/data/synthetic/01_apple_tree_2048x2048_#300_GT --output-dir /home/woody/iwi9/iwi9019h/data/synthetic_results_feature_vec/ --vis wandb --viewer.quit-on-train-completion True --max-num-iterations 36000 --pipeline.datamanager.train-num-rays-per-batch 8192 --pipeline.datamanager.eval-num-rays-per-batch 8192 --pipeline.model.training-steps.semantic 25000 --pipeline.model.training-steps.instance 35000 --optimizers.base-field.scheduler.warmup-steps 0 --optimizers.base-field.scheduler.max-steps 30000 --optimizers.semantic-field.scheduler.warmup-steps 25000 --optimizers.semantic-field.scheduler.max-steps 30000 --optimizers.instance-field.scheduler.warmup-steps 35000 --optimizers.instance-field.scheduler.max-steps 64000 --pipeline.model.training-steps.cascaded-freezing True --pipeline.model.camera-optimizer.mode off --pipeline.model.output-dim-instance 1  --save-only-latest-checkpoint False --steps-per-save 5000 --pipeline.datamanager.train-num-images-to-sample-from -1
ns-train cf-nerf-synthetic-cluster --data /home/woody/iwi9/iwi9019h/data/synthetic/03_plum_tree_2048x2048_#300_GT --output-dir /home/woody/iwi9/iwi9019h/data/synthetic_results_feature_vec/ --vis wandb --viewer.quit-on-train-completion True --max-num-iterations 36000 --pipeline.datamanager.train-num-rays-per-batch 8192 --pipeline.datamanager.eval-num-rays-per-batch 8192 --pipeline.model.training-steps.semantic 25000 --pipeline.model.training-steps.instance 35000 --optimizers.base-field.scheduler.warmup-steps 0 --optimizers.base-field.scheduler.max-steps 30000 --optimizers.semantic-field.scheduler.warmup-steps 25000 --optimizers.semantic-field.scheduler.max-steps 30000 --optimizers.instance-field.scheduler.warmup-steps 35000 --optimizers.instance-field.scheduler.max-steps 64000 --pipeline.model.training-steps.cascaded-freezing True --pipeline.model.camera-optimizer.mode off --pipeline.model.output-dim-instance 1  --save-only-latest-checkpoint False --steps-per-save 5000 --pipeline.datamanager.train-num-images-to-sample-from -1
ns-train cf-nerf-synthetic-cluster --data /home/woody/iwi9/iwi9019h/data/synthetic/08_mango_tree_2048x2048_#300_GT --output-dir /home/woody/iwi9/iwi9019h/data/synthetic_results_feature_vec/ --vis wandb --viewer.quit-on-train-completion True --max-num-iterations 36000 --pipeline.datamanager.train-num-rays-per-batch 8192 --pipeline.datamanager.eval-num-rays-per-batch 8192 --pipeline.model.training-steps.semantic 25000 --pipeline.model.training-steps.instance 35000 --optimizers.base-field.scheduler.warmup-steps 0 --optimizers.base-field.scheduler.max-steps 30000 --optimizers.semantic-field.scheduler.warmup-steps 25000 --optimizers.semantic-field.scheduler.max-steps 30000 --optimizers.instance-field.scheduler.warmup-steps 35000 --optimizers.instance-field.scheduler.max-steps 64000 --pipeline.model.training-steps.cascaded-freezing True --pipeline.model.camera-optimizer.mode off --pipeline.model.output-dim-instance 1  --save-only-latest-checkpoint False --steps-per-save 5000 --pipeline.datamanager.train-num-images-to-sample-from -1
"""


synthetic_data_base_path = '/home/woody/iwi9/iwi9019h/data/synthetic'
synthetic_data_output_base_path = '/home/woody/iwi9/iwi9019h/data/synthetic_results_feature_vec/'
...
parser.add_argument('--fruit_set',
                    type=str,
                    default='03_plum_tree_2048x2048_#300_GT',
                    help='03_plum_tree_2048x2048_#300_GT, 08_mango_tree_2048x2048_#300_GT')
...
run = wandb.init(project='nerfstudio-project',
                 name="{}_{}_counting-pretrained-result-summary_lc_{}_le_{}".format(data_day, fruit_types_all[0], lambda_cosine,
                                                                            lambda_eucl_dist),
                 reinit=True)

# Feature vector dim to try out
#feature_vector_dim_list = [1, 2, 4, 6, 8, 16, 32, 64, 128]
feature_vector_dim_list = [32]
# Schedular
...
for fruit_type in fruit_types_all:
    for feature_vector_dim in feature_vector_dim_list:
        ...
        name = "".join(fruit_type.split("2048x2048_#300_")) + "_feature_dim_" + '{:03d}'.format(feature_vector_dim)
