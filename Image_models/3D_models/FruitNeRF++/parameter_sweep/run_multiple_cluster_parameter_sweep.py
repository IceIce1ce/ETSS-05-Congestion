...
if hostname == 'tinyx':
    ...
    synthetic_data_base_path = '/home/se86kimy/Dropbox/07_data/CF-NeRF/FUJI'
    synthetic_data_output_base_path = '/home/se86kimy/Dropbox/05_productive/01_code/15_ContrastiveFruitNeRF/CF-NeRF/debug/outputs'
else:
...
for fruit_type in fruit_types_all:
    ...
    #list_timestamps = []
    #for current_path in fruit_type_output_folder_cf_nerf.glob("*"):
    #    list_timestamps.append(list(fruit_type_output_folder_cf_nerf.glob("*"))[0].name)

    latest_timestamp = "/home/se86kimy/Dropbox/05_productive/01_code/15_ContrastiveFruitNeRF/CF-NeRF/debug/outputs/FUJI_FruitNeRF_SAM/cf-nerf-fuji/2024-09-13_223233"#sorted(list(fruit_type_output_folder_cf_nerf.glob("*")))[-1]
