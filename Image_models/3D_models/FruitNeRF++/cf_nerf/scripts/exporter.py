...
from cf_nerf.scripts.exporter_utils import sample_volume
...
@dataclass
class ExportInstancePointCloud(Exporter):
    ...
    def main(self) -> None:
        ...
        pipeline.model.setup_inference(num_inference_samples=self.num_points_per_side)
        ...
        pcds = sample_volume(
            ...
            instance_feature_dim=pipeline.model.config.output_dim_instance
        )
        ...
        for pcd_name in pcds.keys():
            ...
            if isinstance(pcd, PyntCloud):
                pcd.to_file(pcd_path)
            else:
...
Commands = tyro.conf.FlagConversionOff[
    Union[
        Annotated[ExportInstancePointCloud, tyro.conf.subcommand(name="instance-pointcloud")],
