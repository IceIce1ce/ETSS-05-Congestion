...
from nerfstudio.utils.colormaps import apply_float_colormap, apply_boolean_colormap, ColormapOptions
from nerfstudio.utils.eval_utils import eval_load_checkpoint#eval_setup
from nerfstudio.utils.rich_utils import CONSOLE, ItersPerSecColumn
from nerfstudio.utils.scripts import run_command
from debug.viewer import unpickle_clustering
...
def _render_trajectory_video(
    ...
    colormap_options_backup = colormap_options
                ...
                for rendered_output_name in rendered_output_names:
                    ...
                    if is_depth:
                        ...
                        if rendered_output_name == "semantics":
                            colormap_options = colormap_options_backup
                        else:
...
class BaseRender:
    ...
    load_cluster_pickle: Union[bool, Path] = False
...
class RenderCameraPath(BaseRender):
    ...
    def main(self) -> None:
        ...
        _, pipeline, _, _ = eval_instance_setup(
            self.load_config,
