...
def convert_img_to_label(recording, scale_factor=1):
    base_dir = '3DCotton' #r'D:\3d_phenotyping'
    #recording = 'tree_01'
    segmentation_object_dir = os.path.join(base_dir, f'{recording}/segmentation_object')
    output_dir = os.path.join(base_dir, f'{recording}/segmentation_label')
