...
def main():
    ...
    projection_dir = os.path.join(args.base_dir, args.recording_name, 'exports/projection')
    pcd_dir = os.path.join(args.base_dir, args.recording_name, 'exports/pcd')
    label_dir = os.path.join('3DCotton', args.recording_name, 'segmentation_label')
    orig_img_dir = os.path.join('3DCotton', args.recording_name, 'segmentation_object')
    pcd_path = os.path.join(pcd_dir, 'all_super_cluster_info_nsub_2.npy' )
    ...
    if args.visualize:
        ...
        if args.vis_full_tree:
            pc_path = os.path.join(args.base_dir, args.recording_name, 'exports/pcd', 'point_cloud.ply')
