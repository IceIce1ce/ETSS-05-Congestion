...
def test(args):
    if args.dataset == 'ucf':
        ...
        datasets = Crowd_SH(os.path.join(args.data_dir, 'val'), 512, 8, is_gray=False, method='val')
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='ucf', type=str, choices=['ucf', 'shanghaitech'])
