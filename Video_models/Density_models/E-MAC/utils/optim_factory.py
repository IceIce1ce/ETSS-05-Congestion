...
def get_parameter_groups(model, weight_decay=1e-5, skip_list=(), get_num_layer=None, get_layer_scale=None, decoder_decay=None, decoder_list=(), no_lr_scale_list=[]):
...
def create_optimizer(args, model, get_num_layer=None, get_layer_scale=None, filter_bias_and_bn=True, skip_list=None):
    ...
    if isinstance(model, torch.nn.Module):
        ...
        parameters = [{"params": [p for n, p in model["model"].named_parameters() if p.requires_grad], "lr_scale": 1.0},
                      {"params": [p for n, p in model["balancer"].named_parameters() if p.requires_grad], "lr_scale": args.balancer_lr_scale}]
    ...
    if opt_lower == "sgd" or opt_lower == "nesterov":
        ...
        print('This optimzier does not exist')
